...
//   Stepper, Step, StepLabel, Box, Paper,
...
// import "../css/servicePurchase.css";

// export default function ServicePurchase() {
//   const theme = useTheme();

//   // 1. Stepper Steps (5 Steps as requested)
//   const steps = [
//     "Form Fill",
//     "Submission",
//     "Contact",
...
//   // 2. Service Options
//   const services = [
//     { name: "Custom Web Development", icon: <CodeIcon />, desc: "Scalable coding solutions" },
//     { name: "UI / UX Design", icon: <BrushIcon />, desc: "User-centered interfaces" },
//     { name: "Figma Design", icon: <DesignServicesIcon />, desc: "Prototyping & wireframes" },
//     { name: "Logo Design", icon: <BrandingWatermarkIcon />, desc: "Brand identity assets" },
//   ];

//   // 3. State Management (Aligned with Django Model)
//   const [formData, setFormData] = useState({
//     business_name: "", // Changed from Full Name
//     website_type: "",
//     details: "",
//     budget: "",
//     email: "",
...
//   return (
//     <section className={`purchaseSection ${theme.palette.mode === "dark" ? "darkPurchase" : "lightPurchase"}`}>
...
//           <Typography variant="h3" className="purchaseMainTitle">
//             Work With Our Experts
//           </Typography>
//           <Typography variant="body1" className="purchaseMainSubtitle">
//             Provide your business details below to initiate the professional design process.
//           </Typography>
//         </div>

//         <div className="purchaseWrapper">
//           {/* LEFT: SERVICE SELECTION */}
//           <div className="serviceSelectSide">
//             <Typography variant="h5" className="sideTitle">1. Select Service</Typography>
//             <div className="serviceList">
//               {services.map((service, index) => (
//                 <div
//                   key={index}
//                   className={`serviceItem ${formData.website_type === service.name ? "activeService" : ""}`}
//                   onClick={() => handleServiceSelect(service.name)}
//                 >
//                   <div className="serviceIcon">{service.icon}</div>
//                   <div className="serviceText">
//                     <span className="serviceName">{service.name}</span>
//                     <span className="serviceDesc">{service.desc}</span>
//                   </div>
//                 </div>
//               ))}
//             </div>
...
//           {/* RIGHT: FORM WITH RESPONSIVE ROWS */}
//           <Paper className="formSide" elevation={0}>
//             <Typography variant="h5" className="formTitle">2. Business Details</Typography>
...
//                   onChange={handleInputChange}
//                   InputProps={{
//                     startAdornment: <InputAdornment position="start"><WhatsAppIcon fontSize="small" /></InputAdornment>,
//                   }}
//                 />
//               </div>
...
//                 onChange={handleInputChange}
//                 InputProps={{
//                   startAdornment: <InputAdornment position="start"><PaymentsIcon fontSize="small" /></InputAdornment>,
//                 }}
//               />
...
//               {/* YELLOW ALERT / NOTICE BOX */}
//               <Alert severity="warning" className="yellowAlert" icon={<InfoIcon fontSize="inherit" />}>
//                 <AlertTitle>Important Note</AlertTitle>
//                 After submission, our lead designer will reach out via <strong>WhatsApp</strong> to discuss technical requirements before delivery.
//               </Alert>
...
//               >
//                 {formData.website_type ? `Request ${formData.website_type}` : "Choose a Service"}
//               </Button>
//             </form>
//           </Paper>
//         </div>
