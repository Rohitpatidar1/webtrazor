...
class Category(models.Model):
    ...
    parent = models.ForeignKey("self", null=True, blank=True, on_delete=models.CASCADE, related_name="subcats")
...
class ProjectMedia(models.Model):
    ...
    def save(self, *args, **kwargs):
        if self.file:
            ...
            if any(ext in url_lower for ext in [".mp4", ".mov", ".avi", "video/upload"]):
                self.type = "video"
            else:
                self.type = "image"
