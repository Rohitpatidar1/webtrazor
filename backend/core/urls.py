...
urlpatterns = [
    ...
    path("providers/<str:service>/<str:location>/", views.providers_list, name="providers_list"),
    ...
    path("project/update-full/<int:project_id>/", views.update_project_with_media, name="update_project_full"),
    ...
    path("admin/delete-feedback/<int:pk>/", views.delete_generic, {'model_name': 'feedback'}),
    path("admin/delete-build-request/<int:pk>/", views.delete_generic, {'model_name': 'build'}),
    path("admin/delete-service-request/<int:pk>/", views.delete_generic, {'model_name': 'service'}),
    path("project/delete/<int:pk>/", views.delete_generic, {'model_name': 'project'}),
    path("project/media/delete/<int:pk>/", views.delete_generic, {'model_name': 'media'}),
    ...
    path("latest-service-requests/", views.service_request, name="latest_service_requests"),
]